...
\multicolumn{1}{c}{\textbf{\Large CAPSTONE PROJECT}}\\[0.8cm]
\textbf{\large SEMESTER 252 ACADEMIC YEAR 2025-2026}\\[0.5cm]
\hline
\\[0.5cm]
...
\begin{center}
\begin{tabular}{l l l}
\textbf{\large COUNCIL} & : & \text{\large CAPSTONE PROJECT - 3CC} \\[0.3cm]
\textbf{\large SUPERVISOR(s)} & : & \text{\large ASSOC. PROF. QUAN THANH THO} \\[0.3cm]
\textbf{\large REVIEWER} & : & \text{\large LE DINH THUAN, M.Eng} \\
\\[0.3cm] 

...
\begin{itemize}
    ...
    \item Fundamental data structures such as stacks, queues, linked lists, hash tables, and trees
    \item Graph algorithms, including breadth-first search (BFS), depth-first search (DFS), and shortest path algorithms
...
\input{Contents/Chapter 1/Related Work/index.tex}
\newpage

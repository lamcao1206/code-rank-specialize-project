...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Primary User/contest-1.jpeg}
%     \vspace{0.6cm}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Primary User/contest-3.jpeg}
%     \vspace{0.6cm}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Primary User/contest-4.jpeg}
%     \vspace{0.6cm}
%     \caption{Contest Detail}
% \end{figure}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Primary User/contest-2.jpeg}
%     \vspace{0.6cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Primary User/inteview-1.png}
    \vspace{0.6cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Admin/Problem_detail_1.png}
    \vspace{0.6cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Admin/Problem_detail_2.png}
    \vspace{0.6cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Contents/Chapter 4/Mockup Design/Admin/Problem_confirm_modal.png}
    \vspace{0.6cm}

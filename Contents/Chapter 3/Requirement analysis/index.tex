...
\begin{enumerate}[label=\arabic*.]
    \item \textit{Authentication:}
        \begin{itemize}
            \item The system shall allow users to create an account using email and password or third-party authentication providers (Google).
            \item The system shall support secure login and logout functionality.
            \item The system shall enforce role-based access control to differentiate between standard users, moderators, and superadmin.
        \end{itemize}
    ...
    \item \textit{Contest:}
        \begin{itemize}
            \item The system shall allow users to participate in timed programming contests.
            \item The system shall provide real-time ranking and automated leaderboards during contests.
        \end{itemize}
    ...
    \item \textit{Interview Preparation (Virtual Assistant):}
        \begin{itemize}
            \item The system shall provide an AI agent to support coding interview practice by explaining algorithms, data structures, problem-solving patterns, and complexity analysis.
            \item The system shall recommend practice problems based on topic, difficulty, and the user's solved or unsolved problem history.
            \item The system shall assist users in debugging failed submissions by providing hints, identifying bugs, explaining test case issues, and suggesting correct or optimal approaches.
        \end{itemize}
\end{enumerate}
\vspace{0.3cm}
...
\begin{enumerate}
    ...
    \item \textit{Contest Management:}
        \begin{itemize}
            \item The system shall allow moderators to create and manage programming contests.
            \item The system shall enable moderators to define contest duration and problem sets.
            \item The system shall provide real-time monitoring of contest progress and participant activity.
        \end{itemize}
    \item \textit{User Management:}
        \begin{itemize}
            \item The system shall allow moderators to view detailed user account information.
            \item The system shall allow moderators to enable or disable user accounts when necessary.
        \end{itemize}

    \item \textit{Submission Management:}
        \begin{itemize}
            \item The system shall allow moderators to view the list of user submissions.
            \item The system shall enable moderators to filter submissions by user, problem, status, programming language, and submission time.
        \end{itemize}

    \item \textit{Notification Management:}
        \begin{itemize}
            \item The system shall allow moderators to create, edit, and delete global system notifications.
            \item The system shall allow moderators to view and manage the visibility status of notifications.
        \end{itemize}
\end{enumerate}
\vspace{0.3cm}
...
\begin{enumerate}
    \item \textit{User and Moderator Account Management:}
        \begin{itemize}
            ...
            \item The system shall enable the Superadmin to warn or ban users who violate community guidelines.
        \end{itemize}
\end{enumerate}

\subsection{Non-functional requirements}
\noindent \textit{Performance:} The system shall support at least 1,000 concurrent users while maintaining minimal latency during contests. Code submissions must be evaluated and feedback returned within 5 seconds for standard test cases, ensuring a responsive and smooth user experience.\\
...
\noindent \textit{Security:} The system shall safeguard user accounts, code submissions, and any sensitive data through industry-standard security measures, such as encryption, secure authentication, and role-based access control.\\
